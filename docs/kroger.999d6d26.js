...
},{"./_set-species":"Bn5Q"}],"p7vl":[function(require,module,exports) {
'use strict';
var anObject = require('./_an-object');
var toPrimitive = require('./_to-primitive');
var NUMBER = 'number';
...
},{"./cjs/react-dom.production.min.js":"jF7N"}],"FpBa":[function(require,module,exports) {
"use strict";
...
},{"react":"HdMw","@emotion/cache":"gt9O","@emotion/utils":"vMii","@emotion/serialize":"ukdS","@emotion/sheet":"FpBa","@emotion/css":"rY+R"}],"hRTX":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"Wzmt"}],"bVQl":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var ENDPOINT = 'https://stream-restaurant-menu-svc.herokuapp.com';
var _default = ENDPOINT;
exports.default = _default;
},{}],"Tb/K":[function(require,module,exports) {
"use strict";
...
var listStyle = (0, _core.css)(_templateObject());

var List = function List(_ref) {
  var onCategoryChange = _ref.onCategoryChange;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios.default.get("".concat(_endpoint.default, "/category"));
  ...
  var handleCategoryChange = function handleCategoryChange(selectedCategory) {
    console.log("setting cat to: ".concat(selectedCategory.id));
  ...
  return (0, _core.jsx)("div", {
    ...
    css: listStyle
  }, (0, _core.jsx)("h3", null, "Menu categories:"), categories.map(function (category) {
    return (0, _core.jsx)("div", {
      className: "category-list-item ".concat(!!activeCategory && activeCategory.id === category.id ? 'selected' : ''),
      key: category.id,
      onClick: function onClick() {
        return handleCategoryChange(category);
      }
    }, "".concat(category.name, " - (").concat(category.short_name, ")"));
  }));
};

var _default = List;
exports.default = _default;
},{"react":"HdMw","@emotion/core":"TSrg","axios":"O4Aa","./endpoint":"bVQl"}],"n1+r":[function(require,module,exports) {
"use strict";
...
var tableStyle = (0, _core.css)(_templateObject());

var Menu = function Menu(_ref) {
  var _ref$categoryShortNam = _ref.categoryShortName,
      categoryShortName = _ref$categoryShortNam === void 0 ? null : _ref$categoryShortNam;
  ...
  var fetchItemsByCategory =
  /*#__PURE__*/
  function () {
    var _ref2 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(categoryShortName) {
      var response;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios.default.get("".concat(_endpoint.default, "/item?category=").concat(categoryShortName));
    ...
    return function fetchItemsByCategory(_x) {
      return _ref2.apply(this, arguments);
    };
  ...
  }, "Items in Category: (".concat(categoryShortName, ")")), (0, _core.jsx)("table", {
    css: tableStyle
  }, (0, _core.jsx)("thead", null, (0, _core.jsx)("tr", null, (0, _core.jsx)("th", null, "Name"), (0, _core.jsx)("th", null, "Description"), (0, _core.jsx)("th", null, "Price"))), (0, _core.jsx)("tbody", null, menuItems.map(function (item) {
    return (0, _core.jsx)("tr", {
      key: item.id
    }, (0, _core.jsx)("td", null, item.name), (0, _core.jsx)("td", null, item.description), (0, _core.jsx)("td", null, "$".concat(item.price_large, ".00")));
  }))));
};

var _default = Menu;
exports.default = _default;
},{"react":"HdMw","@emotion/core":"TSrg","axios":"O4Aa","./endpoint":"bVQl"}],"Focm":[function(require,module,exports) {
"use strict";
...
// Style for whole app
var mainStyle = (0, _core.css)(_templateObject()); // Style for grid containing category list and menu items

var menuGridStyle = (0, _core.css)(_templateObject2()); // Root component
...
var App = function App() {
  ...
  var onCategoryChange = function onCategoryChange(newCategory) {
